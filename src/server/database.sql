...
CREATE TABLE posts (
    ...
    children_post_id INT DEFAULT NULL,
    post_author_id INT NOT NULL,
    FOREIGN KEY (children_post_id) REFERENCES posts (post_id) ON DELETE CASCADE,
...
CREATE TABLE messages (
    ...
    children_message_id INT DEFAULT NULL,
    sender_id INT NOT NULL,
    recipient_id INT NOT NULL,
    FOREIGN KEY (children_message_id) REFERENCES messages (message_id) ON DELETE CASCADE,
